  ...
  <div id="main-page">
    ...
    <div>
      <div class="meeting-card zoom-meeting" @click="loadExternalApp('zoom', path_to_zoom)">
        ...
        <p class="text-end text-white">Launch<br><span>Zoom Meeting</span></p>
      </div>
    </div>
    ...
    <div>
      <div class="meeting-card goto-meeting" @click="loadExternalApp('goto', path_to_goto)">
        ...
        <p class="text-end text-white">Launch<br><span>GoTo Meeting</span></p>
      </div>
    </div>
    ...
    <div>
      <div class="meeting-card microsoft-teams" @click="loadExternalApp('team', path_to_team)">
        ...
        <p class="text-end text-white">Launch<br><span>Microsoft Teams</span></p>
      </div>
    </div>
